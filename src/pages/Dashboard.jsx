...
{user && user.usernm ? (
  ...
  <h2 className="text-xl font-semibold text-gray-500 mt-6">Loading user data...</h2>
)}
            ...
            <p className="mb-8 leading-relaxed text-left text-justify">
              Proyek ini bertujuan untuk membuat alat yang bisa mengambil data dari
              dokumen PDF dan mengubahnya ke format yang bisa digunakan di SQL.
              Karena beberapa PDF berbentuk gambar atau hasil scan, kita mungkin
              perlu menggunakan OCR (Optical Character Recognition) serta teknik
              untuk membersihkan dan menyusun data yang diambil.
            </p>
